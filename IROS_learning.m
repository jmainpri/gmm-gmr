...
tmp = load('data/gestures/8classes_rafi1/compound_0.csv');
Data(:,:,1) = tmp(1:(nb_traj*nb_point_per_traj),:)';
tmp = load('data/gestures/8classes_rafi1/compound_1.csv');
Data(:,:,2) = tmp(1:(nb_traj*nb_point_per_traj),:)';
tmp = load('data/gestures/8classes_rafi1/compound_2.csv');
Data(:,:,3) = tmp(1:(nb_traj*nb_point_per_traj),:)';
tmp = load('data/gestures/8classes_rafi1/compound_3.csv');
Data(:,:,4) = tmp(1:(nb_traj*nb_point_per_traj),:)';
tmp = load('data/gestures/8classes_rafi1/compound_4.csv');
Data(:,:,5) = tmp(1:(nb_traj*nb_point_per_traj),:)';
tmp = load('data/gestures/8classes_rafi1/compound_5.csv');
Data(:,:,6) = tmp(1:(nb_traj*nb_point_per_traj),:)';
tmp = load('data/gestures/8classes_rafi1/compound_6.csv');
Data(:,:,7) = tmp(1:(nb_traj*nb_point_per_traj),:)';
tmp = load('data/gestures/8classes_rafi1/compound_7.csv');
